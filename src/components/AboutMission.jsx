      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-16">
          <div className="glass-panel p-8 rounded-3xl flex flex-col items-center text-center hover-lift">
            <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-neon-accent shadow-[0_0_15px_rgba(157,255,0,0.2)]">
              <Recycle className="w-8 h-8" />
            </div>
            <h4 className="text-xl font-bold text-white mb-3">Zero Waste Focus</h4>
          ...
          <div className="glass-panel p-8 rounded-3xl flex flex-col items-center text-center hover-lift">
            <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-cyan-400 shadow-[0_0_15px_rgba(34,211,238,0.2)]">
              <Globe className="w-8 h-8" />
            </div>
            <h4 className="text-xl font-bold text-white mb-3">Ethical Sourcing</h4>
            <p className="text-gray-400">
          ...
          <div className="glass-panel p-8 rounded-3xl flex flex-col items-center text-center hover-lift">
            <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 text-yellow-400 shadow-[0_0_15px_rgba(250,204,21,0.2)]">
              <Zap className="w-8 h-8" />
            </div>
            <h4 className="text-xl font-bold text-white mb-3">Carbon Neutral</h4>
            <p className="text-gray-400">
