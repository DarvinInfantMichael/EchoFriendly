  ...
  return (
    <div className="flex-1 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto z-10 relative">
        <button 
          onClick={() => navigate(-1)}
          className="text-gray-400 hover:text-white flex items-center gap-2 mb-6 transition-colors group"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="glass-panel p-8 rounded-3xl text-center">
              <div className="w-24 h-24 mx-auto bg-dark-bg/50 border border-white/10 rounded-full flex items-center justify-center mb-4">
            ...
            <div className="glass-panel p-8 rounded-3xl">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="text-white bg-dark-bg/50 border border-white/10 px-4 py-3 rounded-xl">
                    {user.name}
                  </div>
                </div>
